...
const ROLE_PERMISSION_TEMPLATES = {
  ...
  LEADER: [
    ...
    "team.workspace.view",
    "team.approvals.view",
    "team.approvals.leader.approve",
    "team.approvals.leader.reject",
    "team.approvals.acknowledge",
    "auth.user.view",
    "auth.role.view",
    "task.workspace.view",
  ],
  MANAGER: [
    ...
    "team.workspace.view",
    "team.approvals.view",
    "team.approvals.manager.approve",
    "team.approvals.manager.reject",
    "team.approvals.acknowledge",
    "task.workspace.view",
  ],
  ADVERTISER: [
